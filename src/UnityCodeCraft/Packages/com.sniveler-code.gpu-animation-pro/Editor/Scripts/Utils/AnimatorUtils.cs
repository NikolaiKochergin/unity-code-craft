...
namespace SnivelerCode.GpuAnimation.Editor.Utils
{
    ...
    {
        public const string InstanceID = "_SnivelerInstanceID";
    ...
    public static class AnimatorShaderProperty
    {
        ...
        public static int InstanceID => Shader.PropertyToID(AnimatorStrings.InstanceID);
    }

    public static class AnimatorShaderKeywords
    {
        public const string Dqs = "_SNIVELER_DQS";
        public const string AnimStepOnly = "_SNIVELER_ANIM_STEP";
        public const string BoneLod01 = "_SNIVELER_BONE_LOD_1";
        public const string BoneLod02 = "_SNIVELER_BONE_LOD_2";
    }
