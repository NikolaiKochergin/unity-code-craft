...
namespace Zenject
{
    ...
    {
        [SerializeField]
        private bool _parentInstallerPrefabsUnderContext;
        ...
        // Added
        public void AddMonoInstallers(IEnumerable<MonoInstaller> installers)
        {
            if (installers == null) 
                return;
...
//#endif
            ...
            List<MonoInstaller> installerPrefabs)
        {
            ...
            foreach (var installerPrefab in installerPrefabs)
            {
                ...
                if (_parentInstallerPrefabsUnderContext) 
